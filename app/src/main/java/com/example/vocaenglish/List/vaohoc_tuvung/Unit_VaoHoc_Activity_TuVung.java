...
public class Unit_VaoHoc_Activity_TuVung extends AppCompatActivity {
        ...
        call.enqueue(new Callback<List<TuVung>>() {
            ...
            public void onResponse(Call<List<TuVung>> call, Response<List<TuVung>> response) {
                ...
                ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager(),
                        FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT,mlist);
                binding.viewPager.setAdapter(adapter);

                binding.tvCurrentQs.setText("1");

                binding.tvTotalQs.setText(String.valueOf(mlist.size()));
